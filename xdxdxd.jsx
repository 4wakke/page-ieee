...
// const apikeyDolar = import.meta.env.VITE_APP_APIKEY_DOLAR;
  ...
  return (
    <Container className=" flex items-center justify-center min-h-screen">
      ...
      <div className="relative">
        ...
        <div>
        {price && (
          <div className="mt-1 m-1 mx-80 p-2 bg-[#0073ae] rounded border border-[#7b95b4]">
            <h4 className="text-xl font-bold text-center text-white">¡Registro exitoso!</h4>
            <p className="mt-2 text-center text-white">
              El precio a pagar es: <span className="font-bold">${price}</span>
            </p>

            <div className="mt-4 text-center">
              <button onClick={handlePayment} className="bg-[#ffffff] hover:bg-[#c01d0f] text-[#0073ae] px-4 py-2 rounded font-semibold hover:text-[#dadada] tracking-wide duration-300 shadow-md hover:shadow-lg">
                Pagar
              </button>
            </div>
          </div>
