  ...
  return (
    <div className="home flex items-center justify-center px-4 min-h-[85vh] w-full mx-auto">
      ...
      <h2 className="text-2xl sm:text-4xl font-bold text-white mb-4 sm:mb-6 tracking-wid">
        ...
        <Link to="/login">
        <button className="bg-white text-[#0073AE] font-semibold py-2 sm:py-3 px-6 sm:px-7 rounded-full text-base sm:text-lg mb-4 hover:bg-[#005f95] hover:text-white transition-all duration-300 shadow-md hover:shadow-lg tracking-wide w-full sm:w-auto">
          Iniciar sesión
        </button>
        </Link>
